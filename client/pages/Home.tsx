          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
            <div className="lg:col-span-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button size="lg" className="gradient-bg hover:shadow-2xl hover:shadow-primary/30 text-white border-0 px-10 py-5 text-lg font-semibold hover-lift group">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="bg-white text-primary hover:bg-white/90 shadow-xl hover:shadow-2xl px-10 py-5 text-lg font-semibold hover-lift group">
              <Activity className="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" />
              Start Free Trial
            </Button>
